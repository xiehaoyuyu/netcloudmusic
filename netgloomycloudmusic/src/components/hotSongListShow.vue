    ...
    <div class="hotSongListShow-wrap">
      ...
      <div class="hot-detail">
        <div class="songlist-img">
          <img :src="topInfoData.coverImgUrl" alt="" />
        </div>
        <!-- / -->
        <div class="songlist-info">
          <h2>{{ topInfoData.name }}</h2>
          <div class="user-info">
            <a class="user-img" href="javascript:;"
              ><img :src="topInfoData.creator.avatarUrl" alt=""
            /></a>
            <a class="user-name">{{ topInfoData.creator.nickname }}</a
            ><span class="creat-time">2019-05-29 创建</span>
          </div>
          <!-- *btn -->
          <p>
            <el-button
          ...
          <div class="tag">
            <b>标签：</b
            ><a href="javascript:;" class="tag-box">{{
              topInfoData.tags[0]
            }}</a>
          </div>
          <!-- *描述 -->
